"""Ministro de marketing — auto-crm (tipo `saas-crm`).
...
class MarketingLocal(BaseMember):
    """Ministro local de marketing para auto-crm.
    ...
    def retrieve_data(
        ...
        TODO: conectar a data sources reales del dominio marketing.
        Ver `data_sources.md` para config YAML-ish.
        """
        return []


__all__ = ["MarketingLocal"]
