"""Ministro de research — auto-crm (tipo `saas-crm`).
...
class ResearchLocal(BaseMember):
    """Ministro local de research para auto-crm.
    ...
    def retrieve_data(
        ...
        TODO: conectar a data sources reales del dominio research.
        Ver `data_sources.md` para config YAML-ish.
        """
        return []


__all__ = ["ResearchLocal"]
