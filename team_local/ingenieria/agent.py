"""Ministro de ingenieria — auto-crm (tipo `saas-crm`).
...
class IngenieriaLocal(BaseMember):
    """Ministro local de ingenieria para auto-crm.
    ...
    def __init__(self) -> None:
        ...
        self.name = "ingenieria"
        self.dominio = "ingenieria"
        self.base_dir = None
    ...
    def retrieve_data(
        ...
        TODO: conectar a data sources reales del dominio ingenieria.
        Ver `data_sources.md` para config YAML-ish.
        """
        return []


__all__ = ["IngenieriaLocal"]
