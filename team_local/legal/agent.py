"""Ministro de legal — auto-crm (tipo `saas-crm`).
...
class LegalLocal(BaseMember):
    """Ministro local de legal para auto-crm.
    ...
    def retrieve_data(
        ...
        TODO: conectar a data sources reales del dominio legal.
