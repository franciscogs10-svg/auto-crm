"""Ministro de it-devops — auto-crm (tipo `saas-crm`).
...
class ItDevopsLocal(BaseMember):
    """Ministro local de it-devops para auto-crm.
    ...
    def retrieve_data(
        ...
        TODO: conectar a data sources reales del dominio it-devops.
        Ver `data_sources.md` para config YAML-ish.
        """
        return []


__all__ = ["ItDevopsLocal"]
