"""Ministro de producto — auto-crm (tipo `saas-crm`).
...
class ProductoLocal(BaseMember):
    """Ministro local de producto para auto-crm.
    ...
    def retrieve_data(
        ...
        TODO: conectar a data sources reales del dominio producto.
        Ver `data_sources.md` para config YAML-ish.
        """
        return []


__all__ = ["ProductoLocal"]
