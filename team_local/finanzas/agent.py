"""Ministro de finanzas — auto-crm (tipo `saas-crm`).
...
class FinanzasLocal(BaseMember):
    """Ministro local de finanzas para auto-crm.
    ...
    def retrieve_data(
        ...
        TODO: conectar a data sources reales del dominio finanzas.
        Ver `data_sources.md` para config YAML-ish.
        """
        return []


__all__ = ["FinanzasLocal"]
